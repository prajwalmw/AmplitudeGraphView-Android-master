...
public class VoiceRecorder {
    ...
    public boolean startPlotting(GraphView graphView) {
        if (graphView != null) {
            ...
            //Log.d("output","Wave " + String.valueOf(pointList.size()));
            /*for(int i=0;i<pointList.size();i++){
                Long l = pointList.get(i).getAmplitude();
                Log.d("output","Wave " + String.valueOf(l));
            }*/
            return true;
        } else {
            return false;
        ...
        mRecordingThread = new Thread(new Runnable() {
            ...
            public void run() {
                while (!VoiceRecorder.this.stop) {
                    ...
                    //Log.d("output","Wave " + String.valueOf(myAudioRecorder.getMaxAmplitude()));
                    try {
                        Thread.sleep(150);
